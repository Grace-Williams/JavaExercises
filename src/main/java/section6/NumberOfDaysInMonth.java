...
public class NumberOfDaysInMonth {
    ...
    public static boolean isLeapYear(int year){
        ...
        if (isYearValid(year)){
            if (isDivisibleBy4(year) && isNotDivisibleBy100(year) || isDivisibleBy400(year)) {
                return true;
            } else {
                return false;
            }
...
// NOTE: The solution to the Leap Year coding exercise in Section 5 created the isLeapyear method. You can use that solution if you wish
