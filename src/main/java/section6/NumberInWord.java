...
// If the number has any other value than 0 to 9, then the method should print "OTHER"
// You can use an if-else statement or a switch statement to solve this challenge - the choice is yours

// NOTE: The printNumberInWord method needs to be defined as public static
